  ...
  const projects = [
    {
      ...
      description: "Count the number of incoming/entring vehicles",
      imgUrl: projImg1,
    },
    {
      title: "Number Plate Detection",
      description: "Detect the number plate of the vehicle and store the data",
      imgUrl: projImg2,
    },
    { 
      title: "Free Parking Space",
      description: "Reserve your space in the lot! Save your time",
      imgUrl: projImg3,
    },
    // {
